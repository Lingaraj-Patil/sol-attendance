...
export const NEP2020 = memo(function NEP2020() {
  ...
  return (
    <div id="nep2020" className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 to-white overflow-hidden">
        {/* Decorative elements */}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center justify-center min-h-[500px] lg:mt-16">
                <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 p-8 rounded-3xl shadow-2xl text-white">
