...
export const LandingPage = memo(function LandingPage() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50 overflow-hidden">
      ...
      {/* Top accent bar */}
      <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 z-0"></div>
      ...
      <div className="relative z-50 container mx-auto px-8 py-20 mt-8">
        <div className="max-w-3xl">
          ...
          {/* Decorative line */}
          <div className="w-32 h-1 bg-gradient-to-r from-yellow-400 to-yellow-600 mb-8 rounded-full"></div>
          ...
          <p
            ref={sloganRef}
            className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-yellow-400 mb-8 italic"
          ></p>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 transform -skew-y-2 origin-bottom-left shadow-2xl">
